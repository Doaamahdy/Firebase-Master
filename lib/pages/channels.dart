...
import 'package:my_app_1/models/channel.dart';
import 'package:my_app_1/pages/chat.dart';
import 'package:my_app_1/services/channels.dart';
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelStyle: TextStyle(
                                color:
                                    const Color(0xFF1A1F71).withOpacity(0.7)),
                            filled: true,
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                ...
                                final newChannel = ChannelModel(
                                  ...
                                  subscribers: int.tryParse(
                                          _subscribersController.text.trim()) ??
                                      0,
      ...
      children: [
          ...
          onPressed: () async {
            if (userId != null) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content:
                      Text('You must log in first to manage subscriptions.'),
        ...
        TextButton.icon(
          onPressed: () {
            final user = FirebaseAuth.instance.currentUser;
            if (user != null) {
              // Navigate to the ChatPage if authenticated
